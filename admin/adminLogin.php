...
if(isset($_POST['login'])){
    ...
    $sel_user = "select * from admin where admin_email='$email' AND admin_passwprd='$pass'";
    ...
    if($check_user==0){
        ...
        if(!empty($_POST['remember'])) {
            ...
            setcookie('user_pass', $pass, time() + (365 * 24 * 60 * 60));
        } else {
...
<form class="login_form" action="adminLogin.php" method="post">
    ...
    <input class="btn btn-lg btn-primary mt-3 w-100" type="submit" name="login" value="Sign in">
</form>
